...
module.exports = function(config){
  ...
  return {
    run: function(cb){
      ...
      return cb();
      var modulesReq = {};
      var before = "window.module = module = {exports:{}, required:{}};function require(mod){module.required[mod]=true; return {extend:function(){},fn:{extend:function(){},init:function(){}}}};"
