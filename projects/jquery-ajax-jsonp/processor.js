...
module.exports = function(config){
  ...
  return {
    process: function(sha, cb){
      var filename = origin + "src/ajax/jsonp.js";
      var pkg ={
        "name": "jquerycomp/ajax-jsonp",
        ...
        "dependencies":{
          ...
          "jquerycomp/ajax-script": sha.version
        },
        "main": "index.js",
        "scripts": [
          "index.js"
      ...
      src.unshift("var jQuery = require('jquerycomp/ajax-script')");
